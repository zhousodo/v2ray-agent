...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/zhousodo/v2ray-agent/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```

- Stable-v2.4.16【无gRPC】
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/mack-a/zhousodo/stable_v2.4.16/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
